...
export const metadata: Metadata = {
  title: "About - LokFee!",
  description: "Learn about LokFee! - a relationship matching engine built for genuine connection.",
};
      ...
      <section className="relative py-20 lg:py-28 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-foreground mb-6">
            About <span className="text-gradient">LokFee!</span>
          </h1>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="glass-card p-8 lg:p-12">
            ...
            <p className="text-foreground text-lg leading-relaxed mb-6">
              The dating app industry was built on engagement metrics, not relationship success. We created LokFee! to change that.
            </p>
            ...
            <p className="text-foreground-muted leading-relaxed">
              Built on relationship science and powered by AI, LokFee! delivers curated matches with transparency. No games. No misrepresentation. Just real connection.
            </p>
          </div>
        </div>
      </section>
