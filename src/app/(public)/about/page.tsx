    ...
    <div className="pt-24">
      ...
      <section className="py-20 lg:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-white/60 max-w-xl mx-auto">What guides everything we do</p>
          </div>
      ...
      <section className="py-20 lg:py-28 bg-background-secondary/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-white/60 max-w-xl mx-auto">People passionate about helping you find love</p>
          </div>
      ...
      <section className="py-20 lg:py-28">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">Ready to Find Your Match?</h2>
          <p className="text-white/60 mb-8">Join thousands of people who are tired of swiping and ready for real connection.</p>
