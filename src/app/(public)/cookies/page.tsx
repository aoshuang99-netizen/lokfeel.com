        ...
        <div className="glass-card p-8 lg:p-12 space-y-12">
          ...
          <section>
            ...
            <p className="text-white/80 leading-relaxed mb-4">
              This Cookie Policy explains how Nexus (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;) uses cookies and similar tracking technologies when you visit our website at <strong>app.lokfeel.com</strong> and <strong>lokfeel.com</strong> (collectively, the &quot;Service&quot;).
            </p>
          ...
          <section>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-bold text-white">3. How We Use Cookies</h2>
            </div>

            <p className="text-white/80 leading-relaxed mb-4">We use cookies for the following purposes:</p>

            <h3 className="text-lg font-semibold text-white mb-3">3.1 Essential Cookies</h3>
            ...
            <ul className="list-disc list-inside text-white/80 space-y-2 ml-4 mb-6">
            ...
            <h3 className="text-lg font-semibold text-white mb-3">3.2 Analytics Cookies</h3>
            <p className="text-white/80 leading-relaxed mb-2">
            ...
            <h3 className="text-lg font-semibold text-white mb-3">3.3 Functional Cookies</h3>
            <p className="text-white/80 leading-relaxed mb-2">
            ...
            <h3 className="text-lg font-semibold text-white mb-3">3.4 Marketing Cookies (Optional)</h3>
            <p className="text-white/80 leading-relaxed">
          ...
          <section>
            ...
            <div className="space-y-4">
              <div className="glass border-white/10 p-4 rounded-lg">
                ...
                <p className="text-white/60 text-sm">Performance and error monitoring cookies to ensure service reliability.</p>
              </div>
              <div className="glass border-white/10 p-4 rounded-lg">
                <h4 className="font-semibold text-white mb-2">Stripe (Payments)</h4>
                <p className="text-white/60 text-sm">Cookies for secure payment processing. Stripe is PCI DSS compliant.</p>
              </div>
              <div className="glass border-white/10 p-4 rounded-lg">
                <h4 className="font-semibold text-white mb-2">Google OAuth / GitHub OAuth</h4>
                <p className="text-white/60 text-sm">Cookies for third-party authentication services when you choose to sign in with Google or GitHub.</p>
              </div>
              <div className="glass border-white/10 p-4 rounded-lg">
                <h4 className="font-semibold text-white mb-2">Neon (Database)</h4>
                <p className="text-white/60 text-sm">Connection pooling cookies for database performance optimization.</p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <p className="text-white/80 leading-relaxed mb-4">You have the right to decide whether to accept or reject cookies:</p>
            <ul className="list-disc list-inside text-white/80 space-y-2 ml-4">
          ...
          <section>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-bold text-white">7. For California Residents (CCPA / CalOPPA)</h2>
            </div>
