        ...
        <div className="glass-card p-8 lg:p-12 space-y-12">
          ...
          <section>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-bold text-white">4. Legal Bases for Processing</h2>
            </div>
          ...
          <section>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-bold text-white">6. How We Protect Your Data</h2>
            </div>
          ...
          <section>
            ...
            <p className="text-white/80 leading-relaxed mb-4">Depending on your location, you have the right to:</p>
          ...
          <section className="glass border-warning/30">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-bold text-white">9. California Consumer Privacy Act (CCPA) Notice</h2>
            </div>
            ...
            <h3 className="text-lg font-semibold text-white mb-3">9.1 Categories of Personal Information Collected</h3>
            <ul className="list-disc list-inside text-white/80 space-y-2 ml-4 mb-6">
            ...
            <h3 className="text-lg font-semibold text-white mb-3">9.2 Your CCPA Rights</h3>
            <ul className="list-disc list-inside text-white/80 space-y-2 ml-4 mb-6">
            ...
            <h3 className="text-lg font-semibold text-white mb-3">9.3 How to Exercise Your Rights</h3>
